...
At line:1 char:1
+ & "C:\Program Files\nodejs/node.exe" "C:\Users\praco\AppData\Roaming\ ...
+ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
CREATE TABLE "Client" (
    ...
    "keyFindings" TEXT,
    "stage" "ContractorStage" NOT NULL DEFAULT 'LEAD',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "ownerId" TEXT,
    "fromLeadId" TEXT,
...
CREATE TABLE "Case" (
    ...
    "processStage" "SaleProcessStage" NOT NULL DEFAULT 'NEW',
    "detailedStatus" "SaleDetailedStatus" NOT NULL DEFAULT 'WAITING_SURVEY',
